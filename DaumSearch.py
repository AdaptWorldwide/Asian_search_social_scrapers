...
#Globals
BaseURL = 'http://search.daum.net/search?w=web&nil_search=btn&DA=NTB&enc=utf8&lpp=10&q='
...
def GetLinks(soup):
    resultBoxes = soup.findAll('div',attrs={'class':'wrap_tit'})
    Results = []
...
def PrintToCSV(results,keyword):
    ...
    with open('DaumSearch.txt','a',encoding='utf-8') as DaumResults:
